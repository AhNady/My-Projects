...
<body>
	<div class="generic-container">
		...
		<div class="well lead">Employee Form</div>
		<form:form method="POST" modelAttribute="user" class="form-horizontal">
			<form:input type="hidden" path="id" id="id" />

			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="userName">Log In
						User Name</label>
					<div class="col-md-7">
						<c:choose>
							<c:when test="${edit}">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="password">Log In
						Password</label>
					<div class="col-md-7">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="directManager">Direct
						Manager</label>
					<div class="col-md-7">
						<form:input type="text" path="directManager" id="directManager"
							class="form-control input-sm" />
						<div class="has-error">
							<form:errors path="directManager" class="help-inline" />
						</div>
					</div>
				</div>
			</div>
				...
				<c:when test="${user.userProfile.type=='HRADMIN'}">
					<div class="row">
						<div class="form-group col-md-12">
							...
							<div class="col-md-7">
								<form:select path="userProfile" items="${roles}" itemValue="id"
